													...
													(this.$d = (function (t, e, s) {
														try {
															...
															return c
																...
																: s
																? new Date(Date.UTC(g, m, f, b, v, y, w))
																: new Date(g, m, f, b, v, y, w);
														} catch (t) {
															return new Date("");
														}
													})(e, o, i)),
								...
								Array.from(r).forEach((t) => {
									...
									"desc" == s
										? ((p = o(h, -1)),
										  ...
										  u.setAttribute("aria-sort", "descending"))
										: ((p = o(l, 1)),
										  (f = o(h, 1)),
										  u.classList.remove("desc"),
										  u.classList.add("asc"),
										  u.setAttribute("aria-sort", "ascending")),
									a.lastTh &&
										u != a.lastTh &&
										(a.lastTh.classList.remove("desc"),
										a.lastTh.classList.remove("asc"),
										a.lastTh.removeAttribute("aria-sort")),
									(a.lastTh = u),
									(r = p.concat(f)),
									(a.data = []);
								const g = [];
					...
					s.DataTable = class {
						constructor(t, e = {}) {
							...
							if (
								...
								(this.rows = new h(this)),
								(this.columns = new l(this)),
								(this.initialized = !1),
						...
						render() {
							...
							if (
								...
								this.options.perPageSelect.forEach((t) => {
									...
									(e = e.replace("{select}", s.outerHTML)),
									(t = t.replace("{select}", e));
							...
							e.appendChild(s),
								(t = t.replace(/\{pager\}/g, e.outerHTML)),
									...
									if ("txt" === l.type || "csv" === l.type) {
										for (o = "", n = 0; n < s.length; n++) {
											for (r = 0; r < s[n].cells.length; r++)
												if (
													...
													this.columns.visible(e[r].originalCellIndex)
												) {
										...
										for (
											...
											!l.skipColumn.includes(e[n].originalCellIndex) &&
												this.columns.visible(e[n].originalCellIndex) &&
												(o += `\`${e[n].textContent}\`,`);
										for (
											o = o.trim().substring(0, o.length - 1),
												o += ") VALUES ",
						...
						import(t) {
							...
							if (s.data.length || i(s.data)) {
								if ("csv" === s.type) {
									...
									t.length &&
										(s.headings &&
											((e.headings = t[0].split(s.columnDelimiter)),
											s.removeDoubleQuotes &&
												(e.headings = e.headings.map((t) =>
													t.trim().replace(/(^"|"$)/g, "")
												)),
											t.shift()),
										t.forEach((t, i) => {
